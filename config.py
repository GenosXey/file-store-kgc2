...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002278232343"))
...
OWNER_TAG = os.environ.get("OWNER_TAG", "Sankare87")
...
U_S_E_P = True if (True if os.environ.get('U_S_E_P', "FALSE") == "FALSE" else False) and (USE_SHORTLINK) else False
...
ADMIN_LIST = os.environ.get("ADMINS", "1682759613 7428552084").split()
